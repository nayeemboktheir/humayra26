...
const shippingCategories: RateCategory[] = [
  {
    heading: "Category A — 800 Tk/Kg",
    description: "Without Battery, Liquid, Magnet",
    items: [
      { name: "Shoes & Sandals", rate: "800 Tk/Kg" },
      { name: "Bags (all types)", rate: "800 Tk/Kg" },
      { name: "Jewelry & Accessories", rate: "800 Tk/Kg" },
      { name: "Appliances", rate: "800 Tk/Kg" },
      { name: "Stickers & Decals", rate: "800 Tk/Kg" },
      { name: "Electronics (no battery)", rate: "800 Tk/Kg" },
      { name: "Computer Accessories", rate: "800 Tk/Kg" },
      { name: "Ceramics", rate: "800 Tk/Kg" },
      { name: "Metal Products", rate: "800 Tk/Kg" },
      { name: "Leather Products", rate: "800 Tk/Kg" },
      { name: "Rubber & Plastic Products", rate: "800 Tk/Kg" },
      { name: "Toys", rate: "800 Tk/Kg" },
    ],
  },
  {
    heading: "Category B — 1070 Tk/Kg",
    description: "With Battery",
    items: [
      { name: "Battery-type Products", rate: "1070 Tk/Kg" },
      { name: "Duplicate/Copy Brand Products", rate: "1070 Tk/Kg" },
      { name: "Networking Items", rate: "1070 Tk/Kg" },
      { name: "Magnet / Laser Products", rate: "1070 Tk/Kg" },
    ],
  },
  {
    heading: "Category C — Special Items",
    items: [
      { name: "Clothing / Garments", rate: "800 Tk/Kg" },
