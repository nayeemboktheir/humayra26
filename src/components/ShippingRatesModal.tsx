...
const shippingCategories: RateCategory[] = [
  ...
  {
    heading: "Category B — 1050 Tk/Kg",
    description: "With Battery",
    items: [
      { name: "Battery-type Products", rate: "1050 Tk/Kg" },
      { name: "Duplicate/Copy Brand Products", rate: "1050 Tk/Kg" },
      { name: "Networking Items", rate: "1050 Tk/Kg" },
      { name: "Magnet / Laser Products", rate: "1050 Tk/Kg" },
    ],
  },
  {
