      ...
      <div className="border-t-4 border-primary bg-card">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <img src={logoFull} alt="TradeOn Global" width={662} height={208} className="h-20 object-contain" />
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              <a href={settings.facebook_url || "https://facebook.com"} target="_blank" rel="noopener noreferrer"
                aria-label="TradeOn Global on Facebook"
              ...
              <a href={settings.youtube_url || "https://youtube.com"} target="_blank" rel="noopener noreferrer"
                aria-label="TradeOn Global on YouTube"
              ...
              {settings.whatsapp_number && (
                <a href={`https://wa.me/88${(settings.whatsapp_number || "").replace(/-/g, "")}`} target="_blank" rel="noopener noreferrer"
                  aria-label="Contact TradeOn Global on WhatsApp"
        ...
        {/* Copyright */}
        <div className="border-t mt-6 pt-6 text-center text-sm text-muted-foreground space-y-2">
