...
export default function ProductDetail({ product, isLoading, onBack }: ProductDetailProps) {
    ...
    const probeProvince = async (province: string): Promise<DomesticShippingQuote | null> => {
      try {
        ...
        if (!error && data?.success && data?.data) {
          const d = data.data;
          // Use TMAPI's real total fee when product weight is available.
  ...
  }, [product?.num_iid, product?.item_weight, selectedDomesticQty]);
              ...
              <CardContent className="p-0">
                ...
                <div className="flex items-center justify-center py-4 border-b border-border">
                  ...
                  <div className="ml-2">
                    ...
                    <span className="text-xs text-muted-foreground ml-2">৳750/ ৳1050 Per Kg</span>
                  </div>
                </div>
                ...
                <div className="p-4 space-y-3">
                  ...
                  <div className="border rounded-lg p-3 space-y-1">
                    ...
                    <p className="text-xs text-muted-foreground">৳750/ ৳1050 Per Kg</p>
                  </div>
