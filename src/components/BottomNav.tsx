...
import logoIcon from "@/assets/logo-icon.png?w=256&format=webp";
...
const BottomNav = () => {
  ...
  return (
    <>
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-50 bg-card border-t lg:hidden safe-area-bottom">
